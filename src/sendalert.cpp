...
2. run btcgreend with -printalert or -sendalert like this:
   /path/to/btcgreend -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.btcgreen.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Btcgreen Core:0.12.0.58/"));
