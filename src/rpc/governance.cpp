...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in btcgreen.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("btcgreen.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Btcgreen features */
    { "btcgreen",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "btcgreen",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "btcgreen",               "gobject",                &gobject,                true,  {} },
    { "btcgreen",               "voteraw",                &voteraw,                true,  {} },
