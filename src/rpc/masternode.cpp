...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Btcgreen address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "btcgreen",               "masternode",             &masternode,             true,  {} },
    { "btcgreen",               "masternodelist",         &masternodelist,         true,  {} },
    { "btcgreen",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "btcgreen",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "btcgreen",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "btcgreen",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
