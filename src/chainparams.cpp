...
public:
    CMainParams() {
        ...
        nDefaultPort = 1993;
        bnProofOfWorkLimit = ~uint256(0) >> 20;  // Btcgreen starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 210000;
        nEnforceBlockUpgradeMajority = 750;
        nRejectBlockOutdatedMajority = 950;
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 0;
        nTargetTimespan = 24 * 60 * 60; // Btcgreen: 1 day
        nTargetSpacing = 2.5 * 60; // Btcgreen: 2.5 minutes
        ...
        vSeeds.push_back(CDNSSeedData("fxtechcore.io", "dnsseed.fxtechcore.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        /*vSeeds.push_back(CDNSSeedData("fxtechcore.io", "testnet-seed.fxtechcore.io"));
