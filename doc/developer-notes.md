...
However, in open source software such as Btcgreen Core, where everyone uses
...
pay attention to for reviewers of Btcgreen Core code.

General Btcgreen Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Btcgreen Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Btcgreen Core so that they can be integrated
