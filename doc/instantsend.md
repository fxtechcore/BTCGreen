...
This mechanism has been integrated into Bitcore-Node-Btcgreen which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fxtechcore/insight-api-btcgreen#web-socket-api](https://github.com/fxtechcore/insight-api-btcgreen#web-socket-api)
* API: [https://github.com/fxtechcore/insight-api-btcgreen#instantsend-transactions](https://github.com/fxtechcore/insight-api-btcgreen#instantsend-transactions)
...
By default, the Btcgreen Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Btcgreen Core daemon:
