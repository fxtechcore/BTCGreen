...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid btcgreen address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid btcgreen address" in e.error['message'])
